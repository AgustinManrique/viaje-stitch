    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex items-center gap-4 mb-8">
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-pink-300 to-purple-400 flex items-center justify-center text-white font-bold text-2xl">L</div>
          <div>
            <h2 className="text-2xl font-bold text-slate-900">Lucía Fernández</h2>
            <p className="text-slate-500 text-sm">6 años · 1° grado · TDAH · Sesión semanal</p>
          </div>
